...
const customer_api_client_1 = require("./customer-api.client");
...
exports.CustomerApiModule = CustomerApiModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [customer_api_client_1.CustomerApiClient],
        exports: [customer_api_client_1.CustomerApiClient],
    })
], CustomerApiModule);
